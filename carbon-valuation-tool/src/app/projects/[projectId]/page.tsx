...
export default async function ProjectPage({
  ...
  return (
    <div className='container custom-home-height overflow-y-auto'>
      <h2 className='my-4 text-2xl font-extrabold text-light-primary flex items-center justify-between'>
        {project.title}
        <Link
      ...
      <div className='flex flex-col gap-4 text-gray-700'>
        ...
        <div className='flex flex-col gap-1 text-sm'>
          <strong className='text-light-primary'>Milestones</strong>
        ...
        <div className='flex flex-col gap-1 text-sm'>
          <strong className='text-light-primary'>Stakeholders</strong>
          <ul className='flex items-center gap-2'>
            {project.stakeholder.map((item) => (
              <li
                className='text-white bg-light-secondary px-4 py-2 rounded-lg font-semibold'
                key={item.name}
              >
                {item.name}
              </li>
        ...
        <div className='text-sm'>
          <div className='flex items-center justify-between'>
            <strong className='text-light-primary'>
              Emissions Calculations
            </strong>
            <Link
              className='border-light-primary border rounded px-2 py-1 hover:bg-light-primary hover:text-white transition hover:shadow-lg'
